...
class DataInterface():
    ...
    def get_axis_coronal(self, src, src_dest):
        print(src_dest)
        print(src)
        tomografias = []
        ...
        for tomo in tomografias:
            ...
            for j in range(len(volume)):
                ...
                m, n = im.shape
                out = im
                io.imsave(os.path.join(src_dest, "Tomo_{}_slice_{}.png".format(str(tomo).zfill(3),str(j).zfill(3))), out)
...
if __name__ == "__main__":
    ...
    src_coronal = "/home/andrei/low-dose/DATASET-256-CORONAL/"
    src_sagittal = "/home/andrei/low-dose/DATASET-256-SAGITTAL/"

    src_segmented = "/home/andrei/low-dose/DATASET-GT/"
    src_segmented_coronal = "/home/andrei/low-dose/DATASET-256-CORONAL-GT/"
    src_segmented_sagittal = "/home/andrei/low-dose/DATASET-256-SAGITTAL-GT/"

    src_lowdose = "/home/andrei/low-dose/DATASET-256 LOW-DOSE/15_projections/"
    src_lowdose_coronal = "/home/andrei/low-dose/DATASET-256-CORONAL LOW-DOSE/15_projections/"
    src_lowdose_sagittal = "/home/andrei/low-dose/DATASET-256-SAGITTAL LOW-DOSE/15_projections/"

    src_lowdose_gt = "/home/andrei/low-dose/DATASET-256 LOW-DOSE/15_projections/"
    src_lowdose_gt_coronal = "/home/andrei/low-dose/DATASET-256-CORONAL LOW-DOSE/15_projections/"
    src_lowdose_gt_sagittal = "/home/andrei/low-dose/DATASET-256-SAGITTAL LOW-DOSE/15_projections/"

    dataset = DataInterface(src_lowdose)
    dataset.get_axis_coronal(src_lowdose, src_lowdose_sagittal)
