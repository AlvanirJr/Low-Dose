...
class UNETsota(nn.Module):
    ...
    def __init__(self):
        ...
        #problema de segmentação de duas classes
        self.conv9_4 = nn.Conv2d(64, 2, kernel_size=1)
...
class UNETmodel(nn.Module):
    ...
    def __init__(self, pretrained_net):
        ...
        #problema de segmentacao de duas classes
